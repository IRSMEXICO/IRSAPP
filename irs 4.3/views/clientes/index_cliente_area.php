        ...
        <?php
	      ...
	      ?>
              ...
              <td><?php echo $row['id_area'];?></td>
							...
							<td>
							<a href="edit_cliente_area.php?nik=<?php echo $row['id_area'];?>" title="Editar datos" class="btn btn-info btn-sm"><span class="oi oi-plus"></span>Editar datos</a>
								<a href="../../controller/del_cliente_area.php?id=<?php echo $row['id_area'];?>" title="Eliminar" onclick="return confirm('¿Esta seguro de borrar al cliente <?php echo $data['cliente'];?>);" class="btn btn-danger btn-sm">Eliminar</a>
                	</td>
