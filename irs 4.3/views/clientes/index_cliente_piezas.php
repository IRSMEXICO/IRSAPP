        ...
        <?php
	      ...
	      ?>
						<tr>
							...
							<td>
							<a href="edit_cliente_piezas.php?nik=<?php echo $row['id_pieza'];?>" title="Editar datos" class="btn btn-info btn-sm"><span class="oi oi-plus"></span>Editar datos</a>
								<a href="../../controller/del_pieza.php?id=<?php echo $row['id_pieza'];?>" title="Eliminar" onclick="return confirm('¿Esta seguro de borrar al cliente <?php echo $row['piezas'];?>);" class="btn btn-danger btn-sm">Eliminar</a>
                	</td>
