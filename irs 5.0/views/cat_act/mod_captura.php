			...
			<form class="form-horizontal" action="../../controller/add_actividad.php" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<input type="text" name="tipo_captura" value="<?php echo $tipo_cap ?>" class="form-control" placeholder="tipo_captura" required>
					</div> 
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">&nbsp;</label>
					<div class="col-sm-6">
						<input type="submit" name="save_captura" class="btn btn-info" value="Guardar datos">
						<a href="cat_captura.php" class="btn btn-danger">Cancelar</a>
						<a href="cat_captura.php" class="btn btn-warning">Regresar al Catalogo</a>
