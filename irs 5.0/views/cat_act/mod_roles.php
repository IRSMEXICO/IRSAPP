...
<?php include('../../views/nav.php');?>
	...
	<div class="container">
		<div class="content">
			<h2>Datos del Catalogo de Roles &raquo; Editar datos</h2>
			<hr />
			<form class="form-horizontal" action="../../controller/add_actividad.php" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="tipo_rol" value="<?php echo $tipo_roles ?>" class="form-control" placeholder="Rol" required>
					</div> 
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">&nbsp;</label>
					<div class="col-sm-6">
						<input type="submit" name="save_rol" class="btn btn-info" value="Guardar datos">
