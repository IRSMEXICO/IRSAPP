		...
		<div class="content">
			...
			<form class="form-horizontal" action="../../controller/add_actividad.php" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="save_registro" class="btn btn-info" value="Guardar datos">
						<a href="cat_reg.php" class="btn btn-danger">Cancelar</a>
						<a href="cat_reg.php" class="btn btn-warning">Regresar al Catalogo</a>
					</div>
				</div>
			</form>
		</div>
