...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?=base_url();?>assets/css/nivo-slider.css">
	      <link rel="stylesheet" href="<?=base_url();?>assets/css/mi-slider.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
      ...
      <a class="navbar-brand" href="#">
          <img src="../../assets/img/irs.png" width="130" height="30" alt="">
      </a>
  ...
  <!--**MENU**-->
    ...
    <div class="slider-wrapper theme-mi-slider">
        <div id="slider" class="nivoSlider">     
            <img src="../../assets/img/1.jpg"  title="#htmlcaption1" />    
            <img src="../../assets/img/2.jpg"  title="#htmlcaption2"  />    
            <img src="../../assets/img/3.jpg"  title="#htmlcaption3" />     
        </div>        
      </div>
      <!--**SLIDER**-->
</body>
